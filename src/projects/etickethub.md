...
- Integrated *Motics* on the backend - allowing tickets to be
bound to customer devices, preventing theft.
- Tested critical business logic, with end to end tests and
unit tests.
