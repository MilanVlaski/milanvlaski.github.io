...
1. Create offline-first web apps to save time during data entry. For gym owners, foresters or similar. **PWA, SPA, Offline-First.**
2. Helping you with a marketing strategy, with crisp landing pages, to increase outreach and customers. For small businesses looking to go online. **Landing page, SEO**.
3. Reverse-engineering existing annoying systems you use day to day, or are interested in owning, and creating more reliable, lightweight versions - to save time. For industry, or businesses managing content.

## 1. The "Field-Ready" App
**Focus**: Reliability in any environment. Stop worrying about Wi-Fi. I build Progressive Web Apps (PWAs) designed specifically for heavy data entry and field work.
